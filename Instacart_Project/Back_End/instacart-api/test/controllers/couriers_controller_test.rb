...
class CouriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create courier" do
    assert_difference('Courier.count') do
      post couriers_url, params: { courier: { image: @courier.image, price: @courier.price, type_name: @courier.type_name } }, as: :json
    end
  ...
  test "should update courier" do
    patch courier_url(@courier), params: { courier: { image: @courier.image, price: @courier.price, type_name: @courier.type_name } }, as: :json
    assert_response 200
  end
